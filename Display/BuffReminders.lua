...
local function SlashHandler(msg)
    ...
    elseif cmd == "testchat" then
        ...
        print("|cff00ccff[BR testchat]|r calling RunMacroText...")
        RunMacroText(prefix .. "BR testchat: RunMacroText")
        print("|cff00ccff[BR testchat]|r calling SendChatMessage...")
        SendChatMessage("BR testchat: SendChatMessage", channel)
